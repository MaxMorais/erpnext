...
erpnext.PurchaseAnalytics = wn.views.TreeGridReport.extend({
	...
	filters: [
		{fieldtype:"Select", fieldname: "tree_type", label: wn._("Tree Type"), options:["Supplier Type", "Supplier", 
			"Item Group", "Item"],
			filter: function(val, item, opts, me) {
				return me.apply_zero_filter(val, item, opts, me);
			}},
		{fieldtype:"Select", fieldname: "based_on", label: wn._("Based On"), options:["Purchase Invoice", 
